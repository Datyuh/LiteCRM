...
namespace LiteCRM.ViewModels
{
    class AddClientViewsModel : BaseViewModel
    {
        ...
        private int _phoneClient;
        public int PhoneClient { get => _phoneClient; set => SetRef(ref _phoneClient, value); }

        private int _mobilPhoneClient;
        public int MobilPhoneClient { get => _mobilPhoneClient; set => SetRef(ref _mobilPhoneClient, value); }
        ...
        private string _statusContract;
        ...
        private ICommand AddClientInBaseCommand { get; }
        public bool CanAddClientInBaseCommandExecute(object p) => true;
        //public void OnAddClientInBaseCommandExecuted(object p) =>
        //{
